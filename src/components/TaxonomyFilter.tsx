...
const TaxonomyFilter = ({
  ...
  return (
    <div className="flex gap-4">
      <Link
        href={pathname}
        className={`flex justify-center items-center text-center px-4 py-1 text-xl font-semibold rounded-full ${!selectedTaxonomyId && !selectedTaxonId
            ...
            {taxonomy.taxons?.map((taxon: any) => {
              ...
              return (
                <Link
                  ...
                  className={`flex justify-center items-center text-center px-4 py-1 text-xl font-semibold rounded-full ${selectedTaxonomyId === taxonomy._id && selectedTaxonId === taxon._id
                      ? 'text-background bg-text'
                      : ''
                    }`}
                >
